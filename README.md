...
Если мы считаем, что блокирование некоторых действий служб со стороны SELinux вполне себе нас устривает, но не хотим забивать журнал аудита записями о таких блокировках, отключим аудит подобных событий. Для примера, выполним отключение аудита событий службы cups-browsed.
